        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <p className="mb-6 text-lg">
              We engage in creating cutting-edge technology solutions that solve
              emerging and perennial problems in the financial services sector.
              We comprise a team of innovative and experienced individuals
      ...
      <Section background="dark">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg mb-8">
            At SabiSave, we are committed to providing financial solutions that
            are secure, accessible, and tailored to meet the unique needs of
            traders. Our team works tirelessly to ensure that our platform
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="bg-dark/20 p-6 rounded-lg">
              ...
              <p>
                User-friendly interface designed for traders of all
            ...
            <div className="bg-dark/20 p-6 rounded-lg">
              ...
              <p>
                Continuous improvement and feature development based on user
                feedback
              </p>
            </div>
          </div>
