...
const NewHeroSection = () => {
  return (
    <div className="relative max-w-[100vw] overflow-hidden bg-gradient-to-br from-[#F7F7F766]/20 to-primary/30 min-h-screen  px-4 md:px-8 lg:px-16 py-12 md:py-20 items-center flex justify-center">
      <div className="container flex flex-col md:flex-row mx-auto pt-10 md:pt-0">
        ...
        <div className="w-full z-10 md:w-1/2 mb-8 md:mb-0 pr-0 md:pr-8 flex flex-col justify-center">
          ...
          <MotionAnimation delay={0.3}>
            <p className="text-gray-500  text-lg md:text-lg 2xl:text-[24px] mb-8 max-w-[280px] md:max-w-[500px] 2xl:max-w-[650px] leading-relaxed md:leading-[2rem] 2xl:leading-[2.5rem]">
          ...
          <MotionAnimation delay={0.5}>
            <div className="flex flex-wrap gap-4 ">
              <p className="font-medium mb-2 w-full bg-gradient-to-br from-blueOne to-blue-200 bg-clip-text text-transparent">
                {" "}
        ...
        <div>
          <img
            src={mockPhoneMobile}
            alt="mock phone"
            className=" md:hidden  absolute z-0  right-[-45%] bottom-[0%] "
          />
        </div>
      </div>
    </div>
